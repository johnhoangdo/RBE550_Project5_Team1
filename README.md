...
8) Check to make sure Genesis is running properly: python3 demo.py gpu (will take a few minutes)
9) python3 tamp_main.py --goal1
...
5) --goal4a //yellow blocks
6) --goal4b //red and green blocks in L shapes
