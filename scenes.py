...
def create_scene_12_yellow_blocks() -> Tuple[Any, Any, Dict[str, Any]]:
    ...
    # Spawn positions moved to X = 0.55-0.75 (away from grid at X = 0.28-0.42)
    positions = [
        (0.75, -0.3, 0.02), (0.75, -0.1, 0.02), (0.75, 0.1, 0.02), (0.75, 0.3, 0.02),
        (0.65, -0.3, 0.02), (0.65, -0.1, 0.02), (0.65, 0.1, 0.02), (0.65, 0.3, 0.02),
