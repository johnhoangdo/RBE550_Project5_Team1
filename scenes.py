...
def create_scene_12_yellow_blocks() -> Tuple[Any, Any, Dict[str, Any]]:
    ...
    # Spawn positions moved to X = 0.50-0.70 (away from grid at X = 0.28-0.42)
    positions = [
        (0.70, -0.3, 0.02), (0.70, -0.1, 0.02), (0.70, 0.1, 0.02), (0.70, 0.3, 0.02),
        (0.60, -0.3, 0.02), (0.60, -0.1, 0.02), (0.60, 0.1, 0.02), (0.60, 0.3, 0.02),
        (0.50, -0.3, 0.02), (0.50, -0.1, 0.02), (0.50, 0.1, 0.02), (0.50, 0.3, 0.02)
    ]
